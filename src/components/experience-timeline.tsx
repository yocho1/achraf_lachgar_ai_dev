  ...
  return (
    <section className="space-y-6" id="experience">
      <div className="flex flex-col gap-2">
        <p className="text-sm uppercase tracking-[0.25em] text-slate-400">Experience</p>
        <h2 className="text-3xl font-semibold text-white sm:text-4xl">Roles, outcomes, and delivery</h2>
        <p className="text-base text-slate-300">
          Vertical timeline with glass connectors and measurable achievements for each role.
        </p>
      </div>
      ...
      <div className="relative space-y-8 border-l border-white/10 pl-6">
        {experience.map((item, idx) => (
          ...
          >
            <span className="absolute -left-[34px] flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-cyan-300 to-emerald-300 text-slate-900 shadow-lg shadow-cyan-500/30">
              <Briefcase className="h-5 w-5" />
            </span>
            <div className="absolute left-[-1px] top-10 h-full w-[2px] bg-gradient-to-b from-cyan-300/70 via-white/40 to-transparent" />
